    ...
    <section className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fadeInUp">
          ...
          <div className="mb-8">
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-light leading-tight mb-4 animate-slideInLeft hover-lift">
              <span className="font-semibold">Raahil</span>
              <span className="text-gray-600 dark:text-gray-400"> Mehta</span>
            </h1>
            
            <div className="flex items-center justify-center space-x-2 mb-6 animate-slideInRight animation-delay-300 stagger-2">
          ...
          {/* Main headline */}
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-tight mb-6 animate-fadeInUp animation-delay-500">
          ...
          {/* Subheading */}
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed animate-fadeInUp animation-delay-700">
            I design web and automation solutions that simplify workflows and scale impact.
          </p>
          
          {/* CTA buttons */}
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20 animate-fadeInUp animation-delay-900 stagger-4">
            <button 
              onClick={() => document.getElementById('work')?.scrollIntoView({ behavior: 'smooth' })}
              className="group px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-500 font-medium magnetic-btn hover-glow relative overflow-hidden"
            >
            ...
            <button 
              ...
              className="px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:border-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/10 transition-all duration-500 font-medium magnetic-btn glass-card"
            >
